...
!      if(iloc.eq.26 .and. jloc.eq.1)then
!      write(6,*) 'inside noahmp','dx=',dx,'dz8w=',dz8w,'stc=',stc
!      endif
...
!energy balance at bare ground: sag*(1.-fveg)=(irb+shb+evb+ghb)*(1.-fveg) at 1-fveg
    ...
    if(fire <=0.) then
       ...
       write(6,*) 'fveg=',fveg,'veg=',veg,'tgb=',tgb
       write(6,*) 'tgv=',tgv,'irg=',irg,'irc=',irc
       write(6,*) 'irb=',irb,'vegtyp=',vegtyp
       write(6,*) 'dx=',dx,'dz8w=',dz8w
       write(6,*) 'stc=',stc
       call wrf_error_fatal("stop in noah-mp")
    end if
